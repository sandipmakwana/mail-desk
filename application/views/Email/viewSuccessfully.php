<html>
<head>
    <title>Visit Card Request</title>
    <style type="text/css">
       table, th, td {
    ...
    box-shadow: 0 2px 5px 0 rgba(0,0,0,.16), 0 2px 10px 0 rgba(0,0,0,.12);text-align:left">
        ...
        <div style="overflow: hidden;">
            <div style="overflow: hidden;">
                ...
                <br />
                <br />
               Declined request for <b><?= $emp_name; ?></b> - <b><?=$token; ?></b> has been successfully submitted. 
                <br/>
                <br/>
               <!--  <center>
                    <button style="background-color:#fff; color:#ff4f5e;" onclick="window.close();" >Close</button>
                </center> -->
            </div>
        </div>
    </div>
