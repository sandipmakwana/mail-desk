				...
				?>
					...
					<div class="form-group has-error"><span class="help-block err" id="err_lgn"></span></div>
						...
						<div class="md-form form-sm">
							...
							<input type="text" placeholder="Enter OTP" id="txt_otp" name="txt_otp" class="form-control" />
							
							<div class="form-group has-error"><span class="help-block err" id="err_txt_otp"></span></div>
						</div>
						<div id="resentotp" onclick="return resentotp();">Resent OTP??</div>
						<div class="text-center">
						<button class="btn btn-danger" onclick="return otp_verification();" style="width:100%">Submit</button>
						</div>
					</form>
					<!-- Form login -->
				</div>
