                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="pink-text"> Edit Request Form </h4><hr>
                             <?php echo form_open_multipart('Emprequest/editRequest','class="form-inner"','autocomplete="off"'); ?>
                                <input type="hidden" name="req_id" id="req_id" value="<?php if(isset($reg->req_id)) echo $reg->req_id; ?>">
                                 <input type="hidden" name="hiddentokenid" id="hiddentokenid" value="<?php if(isset($reg->req_emp_token)) echo $reg->req_emp_token; ?>">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <label>Department/Division <span class="red-text">* </span></label>
