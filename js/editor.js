			...
			var menuItems = { 'fonteffects': true,
						   ...
						   'insert_link': { "modal": true,
											...
											"onSave":function(){
												...
												//var urlPattern = '/^(http|https|ftp):\/\/[a-z0-9]+([\-\.]{1}[a-z0-9]+)*\.[a-z]{2,5}(:[0-9]{1,5})?(\/.*)?$/i';
												...
												/*if(/^(http|https|ftp):\/\/[a-z0-9]+([\-\.]{1}[a-z0-9]+)*\.[a-z]{2,5}(:[0-9]{1,5})?(\/.*)?$/i.test(targetURL)){		
												alert("IN");		
												}
												else{
													
												}	*/						
												//if(!targetURL.test(urlPattern)){
												if(!(/^(http|https|ftp):\/\/[a-z0-9]+([\-\.]{1}[a-z0-9]+)*\.[a-z]{2,5}(:[0-9]{1,5})?(\/.*)?$/i.test(targetURL))){
